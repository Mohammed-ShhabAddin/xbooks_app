...
class _ApiService implements ApiService {
  ...
  @override
  Future<SignupResponse> signup(SignupRequestBody singupRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(singupRequestBody.toJson());
    final _result = await _dio
  ...
  Future<BestSeller> getBestSeller() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<BestSeller>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BestSeller.fromJson(_result.data!);
    return value;
  }

  @override
  Future<NewArrivals> getNewArrivals() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<NewArrivals>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NewArrivals.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Products> getAllBooksProducts(int page) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<Products> getByNameSearchedBooks(String name) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<Profile> showProfile(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
